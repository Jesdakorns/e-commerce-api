...
let ProductTypeModule = exports.ProductTypeModule = class ProductTypeModule {
};
exports.ProductTypeModule = ProductTypeModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([product_type_entity_1.ProductType])],
        controllers: [product_type_controller_1.ProductTypeController],
        providers: [product_type_service_1.ProductTypeService, upload_service_1.UploadService],
    })
], ProductTypeModule);
