...
let AuthController = exports.AuthController = class AuthController {
    ...
    async login(createAuthDto) {
        console.log(`🚀 ~ file: auth.controller.ts ~ line 28 ~ AuthController ~ login ~ createAuthDto`, createAuthDto);
        return this.authService.login(createAuthDto);
    }
    async loginGoogle(createAuthDto) {
        const userInfo = await axios_1.default
            .get('https://www.googleapis.com/oauth2/v3/userinfo', {
            headers: { Authorization: `Bearer ${createAuthDto.accessToken}` },
        })
            .then((res) => res.data);
        console.log(`🚀 ~ file: auth.controller.ts ~ line 72 ~ AuthController ~ loginGoogle ~ userInfo`, userInfo);
        return this.authService.loginGoogle(userInfo);
    }
    async register(registerAuthDto) {
        console.log(`🚀 ~ file: auth.controller.ts ~ line 42 ~ AuthController ~ register ~ registerAuthDto`, registerAuthDto);
...
__decorate([
    ...
    __metadata("design:paramtypes", [login_auth_dto_1.LoginFormDto]),
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [login_auth_dto_1.LoginGoogleFormDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [register_auth_dto_1.RegisterFormDto]),
    __metadata("design:returntype", Promise)
