...
let ProductController = exports.ProductController = class ProductController {
    ...
    findAll(query) {
        console.log(`🚀 ~ file: product.controller.ts ~ line 29 ~ ProductController ~ findAll ~ query`, query);
...
__decorate([
    (0, common_1.Get)('topSell'),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], ProductController.prototype, "findTopSell", null);
__decorate([
    (0, common_1.Get)(':id'),
